...
const AdminSalaryView = ({ darkMode }) => {
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-[#0d1117] p-6 text-gray-900 dark:text-white transition-colors">

      <div className="max-w-3xl mx-auto bg-white dark:bg-[#161b22] p-8 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700">

        <h3 className="text-3xl font-bold mb-6 text-teal-600 dark:text-teal-400">
          Add Salary
        </h3>
        ...
        <form onSubmit={handleAddSalary} className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <select
              ...
              className="bg-gray-100 dark:bg-[#0d1117] border border-gray-300 dark:border-gray-700 p-3 rounded-lg"
              required
            >
      ...
      <div className="max-w-4xl mx-auto mt-10 bg-white dark:bg-[#161b22] p-6 rounded-xl border border-gray-200 dark:border-gray-700">
...
const EmployeeSalaryView = ({ darkMode }) => {
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-[#0d1117] p-6 text-gray-900 dark:text-white">

      <div className="max-w-4xl mx-auto bg-white dark:bg-[#161b22] p-6 rounded-xl border border-gray-200 dark:border-gray-700">

        <h2 className="text-3xl font-semibold text-teal-600 dark:text-teal-400 mb-4">
          My Salary History
        </h2>
...
export default function SalaryPage({ user, darkMode }) {
  ...
  return user.role === "admin"
    ? <AdminSalaryView darkMode={darkMode} />
    : <EmployeeSalaryView darkMode={darkMode} />;
